...
(function (a, b) {
    ...
    function l(a, c, d) {
        if (d === b && a.nodeType === 1) {
            var e = "data-" + c.replace(k, "-$1.txt").toLowerCase();
            d = a.getAttribute(e);
            if (typeof d == "string") {
                try {
    ...
    var c = a.document, d = a.navigator, e = a.location, f = function () {
        ...
        e.fn = e.prototype = {
            ...
            }, selector: "", jquery: "1.txt.7.1.txt", length: 0, size: function () {
                return this.length
            }, toArray: function () {
    ...
    var z = /^(?:textarea|input|select)$/i, A = /^([^\.]*)?(?:\.(.+))?$/, B = /\bhover(\.\S+)?\b/, C = /^key/, D = /^(?:mouse|contextmenu)|click/, E = /^(?:focusinfocus|focusoutblur)$/, F = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, G = function (a) {
        ...
        return f.event.special.hover ? a : a.replace(B, "mouseenter$1.txt mouseleave$1.txt")
    };
    f.event = {
            ...
            preFilter: {
                CLASS: function (a, b, c, d, e, f) {
                    ...
                    if (a[1] === "nth") {
                        ...
                        var b = /(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2] === "even" && "2n" || a[2] === "odd" && "2n+1.txt" || !/\D/.test(a[2]) && "0n+" + a[2] || a[2]);
    ...
    f.fn.css = function (a, c) {
        ...
        get: function (a, b) {
            return br.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || "") ? parseFloat(RegExp.$1) / 100 + "" : b ? "1.txt" : ""
        }, set: function (a, b) {
        ...
        var c, d, e;
        b = b.replace(bs, "-$1.txt").toLowerCase(), (d = a.ownerDocument.defaultView) && (e = d.getComputedStyle(a, null)) && (c = e.getPropertyValue(b), c === "" && !f.contains(a.ownerDocument.documentElement, a) && (c = f.style(a, b)));
        return c
